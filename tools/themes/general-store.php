...
return [
	...
	'departments' => [
		[
			...
			// 'stock' overrides what Pexels is searched for, where the thing's own name is a
			// different common word: "Throw" is a verb, a "Head Torch" is a flame.
			'things' => [
				['name' => 'Skillet', 'suffixes' => ['20 cm', '24 cm', '26 cm', '28 cm'], 'stock' => false],
				['name' => 'Saucepan', 'suffixes' => ['1.5 L', '2 L', '3 L'], 'stock' => false],
				['name' => 'Casserole Dish', 'suffixes' => ['3 L', '4.5 L', '6 L'], 'stock' => false, 'characteristics' => ['Colour']],
				['name' => 'Mixing Bowl', 'suffixes' => ['Small', 'Medium', 'Large'], 'stock' => false, 'characteristics' => ['Colour']],
				['name' => 'Chopping Board', 'suffixes' => ['Small', 'Large']],
				['name' => 'Kettle', 'suffixes' => ['1.5 L', '1.7 L']],
				['name' => 'Cafetière', 'suffixes' => ['3 cup', '8 cup'], 'stock' => 'french press coffee maker'],
				['name' => 'Roasting Tin', 'suffixes' => ['Medium', 'Large'], 'stock' => false],
				['name' => 'Colander', 'suffixes' => ['22 cm', '26 cm'], 'stock' => false],
				['name' => 'Pepper Mill', 'suffixes' => [''], 'stock' => false],
			],
		],
		[
			'name' => 'Clothing',
			...
			'things' => [
				['name' => 'Scarf', 'suffixes' => [''], 'stock' => false, 'characteristics' => ['Colour']],
				['name' => 'Crew Jumper', 'suffixes' => [''], 'stock' => false, 'characteristics' => ['Colour', 'Size']],
				['name' => 'Overshirt', 'suffixes' => [''], 'stock' => false, 'characteristics' => ['Colour', 'Size']],
				['name' => 'Field Jacket', 'suffixes' => [''], 'stock' => false, 'characteristics' => ['Colour', 'Size']],
				['name' => 'Chinos', 'suffixes' => ['30', '32', '34', '36'], 'stock' => false],
				['name' => 'Oxford Shirt', 'suffixes' => [''], 'stock' => false, 'characteristics' => ['Colour', 'Size']],
				['name' => 'Beanie', 'suffixes' => [''], 'stock' => false, 'characteristics' => ['Colour']],
		...
		[
			...
			'things' => [
				['name' => 'Backpack', 'suffixes' => ['20 L', '35 L', '60 L'], 'stock' => false, 'characteristics' => ['Colour']],
				['name' => 'Sleeping Bag', 'suffixes' => ['Comfort 0°C', 'Comfort -5°C', 'Comfort 5°C'], 'stock' => false],
				['name' => 'Head Torch', 'suffixes' => ['200 lm', '400 lm'], 'stock' => false],
				['name' => 'Water Bottle', 'suffixes' => ['500 ml', '750 ml', '1 L'], 'stock' => false, 'characteristics' => ['Colour']],
				['name' => 'Trekking Poles', 'suffixes' => ['Pair'], 'stock' => false],
				['name' => 'Dry Bag', 'suffixes' => ['5 L', '10 L', '20 L'], 'characteristics' => ['Colour']],
				['name' => 'Camping Stove', 'suffixes' => [''], 'stock' => false],
				['name' => 'Hammock', 'suffixes' => ['Single', 'Double'], 'stock' => false],
			],
		],
		[
			'name' => 'Home',
			...
			'things' => [
				...
				['name' => 'Door Mat', 'suffixes' => [''], 'stock' => false],
			],
		],
		[
			'name' => 'Stationery',
			...
			'things' => [
				...
				['name' => 'Desk Pad', 'suffixes' => [''], 'stock' => 'desk mat'],
				['name' => 'Letter Set', 'suffixes' => [''], 'stock' => 'writing paper and envelopes'],
		...
		[
			...
			'things' => [
				['name' => 'Espresso Blend', 'suffixes' => ['250 g', '500 g', '1 kg'], 'stock' => 'espresso coffee beans'],
				['name' => 'Filter Coffee', 'suffixes' => ['250 g', '500 g', '1 kg'], 'stock' => 'ground coffee'],
				['name' => 'Earl Grey', 'suffixes' => ['100 g', '250 g'], 'stock' => false],
				['name' => 'Sencha', 'suffixes' => ['100 g', '250 g'], 'stock' => false],
				['name' => 'Rooibos', 'suffixes' => ['100 g', '250 g'], 'stock' => false],
				['name' => 'Breakfast Blend', 'suffixes' => ['250 g', '500 g'], 'stock' => 'coffee beans bag'],
				['name' => 'Chai', 'suffixes' => ['100 g', '250 g'], 'stock' => false],
			],
		],
	],
