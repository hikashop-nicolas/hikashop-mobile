...
export const en: Messages = {
	...
	'media.editSave': 'Save as new image',
	'media.editFailed': 'The image could not be edited.',
	'media.editShape': 'Shape',
	'media.editSize': 'Size',
	'media.sizeOriginal': 'As cropped',
	'media.sizePx': '{px} px',
	'media.editHint': 'Drag to move, pinch or scroll to zoom, and use the buttons to rotate. The original is left untouched: this is saved as a new image.',
	'media.shape.square': 'Square',
	'media.shape.landscape': 'Landscape',
	'media.shape.portrait': 'Portrait',
	'media.shape.wide': 'Wide',
	'media.edit': 'Edit',
};
